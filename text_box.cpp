...
text_box::text_box(uint16_t x_pos, uint16_t y_pos, sFONT* font, uint8_t font_color){
    this->x_pos=x_pos;
    this->y_pos=y_pos;
...
void text_box::set_font(sFONT* font, epdframe &frame){
...
/*void text_box::select_font(){
    ...
    else if(this->text_font==FREESANS){
        if(this->font_size==8){
            this->font=&FreeSans8;
        }
        else if(this->font_size==12){
            this->font=&FreeSans16;
        }
        else if(this->font_size==16){
            this->font=&FreeSans16;
        }
        else if(this->font_size==20){
            this->font=&FreeSans20;
        }
        else if(this->font_size==24){
            this->font=&FreeSans24;
        }
        else if(this->font_size==28){
            this->font=&FreeSans28;
        }
        else if(this->font_size==32){
            this->font=&FreeSans32;
        }
        else if(this->font_size==36){
            this->font=&FreeSans36;
        }
    }
    else{
